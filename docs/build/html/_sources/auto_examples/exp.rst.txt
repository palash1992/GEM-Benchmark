.. note::
    ...
    Click :ref:`here <sphx_glr_download_auto_examples_exp.py>` to download the full example code
.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_exp.py:
...
.. _sphx_glr_download_auto_examples_exp.py:
...
.. only :: html
 ...
 .. container:: sphx-glr-footer
  ...
  .. container:: sphx-glr-download
     ...
     :download:`Download Python source code: exp.py <exp.py>`



  .. container:: sphx-glr-download

     :download:`Download Jupyter notebook: exp.ipynb <exp.ipynb>`
