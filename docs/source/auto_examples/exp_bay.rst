.. note::
    ...
    Click :ref:`here <sphx_glr_download_auto_examples_exp_bay.py>` to download the full example code
.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_exp_bay.py:
...
.. _sphx_glr_download_auto_examples_exp_bay.py:
...
.. only :: html
 ...
 .. container:: sphx-glr-footer
  ...
  .. container:: sphx-glr-download
     ...
     :download:`Download Python source code: exp_bay.py <exp_bay.py>`



  .. container:: sphx-glr-download

     :download:`Download Jupyter notebook: exp_bay.ipynb <exp_bay.ipynb>`
